...
namespace ENGAGEMENT.Controllers
{
    ...
    public class DetailReglementController : ApiController
    {
        ...
        [HttpGet]
        [Route("GetByReglement/{id}", Name = "GetByReglement")]
        public List<DetailReglementDto> GetByReglement(int id)
        {
            return this.service.GetAll().Where(x => x.IdReglement == id).Select(this.mapper.Map<DetailReglementDto>).ToList();
        }
        ...
        [HttpGet]
        [Route("GetLookup", Name = "GetLookupDetailReglement")]
